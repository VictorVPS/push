<?php 
define('BOT_TOKEN', '5442958695:AAGzlyrMufLZqn8xX1QYaN1okW5M9h9TRCg'); 
...
function processaCallbackQuery($callback){
  $BOT_TOKEN = "5442958695:AAGzlyrMufLZqn8xX1QYaN1okW5M9h9TRCg";
...
*Escolha uma das opções a baixo e clique no botão correspondente.*',
		    'reply_markup' => array('inline_keyboard' => array(                                                                                                        
                                                      //linha 1
                                                     array(
                                                         array('text'=>'➕ Adicione-me a um grupo ➕','url'=>'https://t.me/RasTrecbot?startgroup=start')                                           
                                                      ),
                                                     //linha 2
                                                     array(
...
Conheça abaixo, todos os meus comandos:*', "reply_to_message_id" => $message_id,
         ...
         } else if($member_user == 'RasTrecbot') {
...
*Meu nome é @RasTrecbot. Adicione-me em um grupo e me coloque como Admin para utilizar todos os meus recursos!
